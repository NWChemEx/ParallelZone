...
public:
     ...
     * @details Resourceset instance initializes MADness runtime, sets
     * partitions to 1.
     */
    Resourceset();
    ...
    //     constexpr int get_num_partitions() const noexcept { return
    //     num_partitions; }

    //     /// @return true, if Resourceset (and, necessarily, MADWorld runtime)
    //     is in an
    //     /// initialized state
    ...
    //     /**
    //      * @brief destructor
    //      * @details Destructs the MADness runtime appropriately, if
    //      Resourceset is
    //      * initialized
    //      */
    //     ~Resourceset();

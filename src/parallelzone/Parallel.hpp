...
//
//   Note, make sure that ParallelZone::MPI::Init (or ParallelZone::MPI::Init_thread)
//   is called before using isProc0_macro.
//
#define isProc0_macro ( ParallelZone::Parallel::getMPIRank()      == 0 ) && \
                      ( ParallelZone::Parallel::getMainThreadID() == std::this_thread::get_id() )

...
namespace ParallelZone { 
  namespace MPI {
			   ...
			   int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win )
    {
      ...
      return Impl::mpi_err_check( MPI_Accumulate( origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count,
    ...
    inline int Allgather( MPICONST void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm )
    {
      ...
      return Impl::mpi_err_check(MPI_Allgather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm ));
    }
    inline int Allgatherv( MPICONST void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , MPICONST int *recvcounts , MPICONST int *displs , MPI_Datatype recvtype , MPI_Comm comm )
    {
      ...
      return Impl::mpi_err_check(MPI_Allgatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , comm ));
    }
    ...
    inline int Allreduce( MPICONST void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm )
    {
      ...
      return Impl::mpi_err_check(MPI_Allreduce( sendbuf , recvbuf , count , datatype , op , comm ));
    }
    inline int Alltoall( MPICONST void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcount, recvtype );
      return Impl::mpi_err_check(MPI_Alltoall( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm ));
    }
    inline int Alltoallv( MPICONST void *sendbuf , MPICONST int *sendcounts , MPICONST int *sdispls , MPI_Datatype sendtype , void *recvbuf , MPICONST int *recvcounts , MPICONST int *rdispls , MPI_Datatype recvtype , MPI_Comm comm )
    {
      ...
      Impl::RecvVolumeStats( recvcounts, recvtype, comm );
      return Impl::mpi_err_check(MPI_Alltoallv( sendbuf , sendcounts , sdispls , sendtype , recvbuf , recvcounts , rdispls , recvtype , comm ));
    }
	...
	rcounts += recvcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Alltoallw( sendbuf , sendcounts , sdispls , sendtypes , recvbuf , recvcounts , rdispls , recvtypes , comm ));
    }
    ...
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Bsend( buf , count , datatype , dest , tag , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Bsend_init( buf , count , datatype , dest , tag , comm , request ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Cart_create( comm_old , ndims , dims , periods , reorder , comm_cart ));
    }
    inline int Cart_get( MPI_Comm comm , int maxdims , int dims[] , int periods[] , int coords[] )
    {
      return Impl::mpi_err_check(MPI_Cart_get( comm , maxdims , dims , periods , coords ));
    }
    inline int Cart_map( MPI_Comm comm , int ndims , MPICONST int dims[] , MPICONST int periods[] , int *newrank )
    {
      return Impl::mpi_err_check(MPI_Cart_map( comm , ndims , dims , periods , newrank ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Cart_shift( comm , direction , disp , rank_source , rank_dest ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_accept( port_name , info , root , comm , newcomm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_connect( port_name , info , root , comm , newcomm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_create_errhandler( comm_errhandler_fn , errhandler ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Comm_create_group( MPI_Comm comm , MPI_Group group , int tag , MPI_Comm *newcomm )
    {
      return Impl::mpi_err_check(MPI_Comm_create_group( comm , group , tag , newcomm ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_create_keyval( comm_copy_attr_fn , comm_delete_attr_fn , comm_keyval , extra_state ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_get_attr( comm , comm_keyval , attribute_val , flag ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_set_attr( comm , comm_keyval , attribute_val ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_spawn( command , argv , maxprocs , info , root , comm , intercomm , array_of_errcodes ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_spawn_multiple( count , array_of_commands , array_of_argv , array_of_maxprocs , array_of_info , root , comm , intercomm , array_of_errcodes ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Comm_split_type( comm , split_type , key , info , newcomm ));
    }
#endif
    ...
    inline int Compare_and_swap( const void *origin_addr , const void *compare_addr , void *result_addr , MPI_Datatype datatype , int target_rank , MPI_Aint target_disp , MPI_Win win )
    {
      ...
      return Impl::mpi_err_check(MPI_Compare_and_swap( origin_addr , compare_addr , result_addr , datatype , target_rank , target_disp , win ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Dist_graph_create( comm_old , n , sources , degrees , destinations , weights , info , reorder , comm_dist_graph ));
    }
#endif
#if PARALLELZONE_ENABLE_MPI3
    ...
    {
      return Impl::mpi_err_check(MPI_Dist_graph_create_adjacent( comm_old , indegree , sources , sourceweights , outdegree , destinations , destweights , info , reorder , comm_dist_graph ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Dist_graph_neighbors( comm , maxindegree , sources , sourceweights , maxoutdegree , destinations , destweights ));
    }
    inline int Dist_graph_neighbors_count( MPI_Comm comm , int *indegree , int *outdegree , int *weighted )
    {
      return Impl::mpi_err_check(MPI_Dist_graph_neighbors_count( comm , indegree , outdegree , weighted ));
    }
#endif
    ...
    inline int Exscan( MPICONST void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Exscan( sendbuf , recvbuf , count , datatype , op , comm ));
    }
#if PARALLELZONE_ENABLE_MPI3
    ...
    {
      Impl::OneVolumeStats( 1, datatype);
      return Impl::mpi_err_check(MPI_Fetch_and_op( origin_addr , result_addr , datatype , target_rank , target_disp , op , win ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_File_create_errhandler( file_errhandler_fn , errhandler ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Finalize( ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Gather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , root , comm ));
    }
	...
	Impl::RecvVolumeStats(recvcounts, recvtype, comm );
      ...
      return Impl::mpi_err_check(MPI_Gatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , root , comm ));
    }
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Get( origin_addr , origin_count , origin_datatype , target_rank , target_disp , target_count , target_datatype , win ));
    }
#if PARALLELZONE_ENABLE_MPI3
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Get_accumulate( origin_addr , origin_count , origin_datatype , result_addr , result_count , result_datatype , target_rank , target_disp , target_count , target_datatype , op , win ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Graph_create( comm_old , nnodes , indx , edges , reorder , comm_graph ));
    }
    inline int Graph_get( MPI_Comm comm , int maxindex , int maxedges , int indx[] , int edges[] )
    {
      return Impl::mpi_err_check(MPI_Graph_get( comm , maxindex , maxedges , indx , edges ));
    }
    inline int Graph_map( MPI_Comm comm , int nnodes , MPICONST int indx[] , MPICONST int edges[] , int *newrank )
    {
      return Impl::mpi_err_check(MPI_Graph_map( comm , nnodes , indx , edges , newrank ));
    }
    inline int Graph_neighbors( MPI_Comm comm , int rank , int maxneighbors , int neighbors[] )
    {
      return Impl::mpi_err_check(MPI_Graph_neighbors( comm , rank , maxneighbors , neighbors ));
    }
    inline int Graph_neighbors_count( MPI_Comm comm , int rank , int *nneighbors )
    {
      return Impl::mpi_err_check(MPI_Graph_neighbors_count( comm , rank , nneighbors ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Grequest_start( query_fn , free_fn , cancel_fn , extra_state , request ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Group_intersection( group1 , group2 , newgroup ));
    }
    inline int Group_range_excl( MPI_Group group , int n , int ranges[][3] , MPI_Group *newgroup )
    {
      return Impl::mpi_err_check(MPI_Group_range_excl( group , n , ranges , newgroup ));
    }
    inline int Group_range_incl( MPI_Group group , int n , int ranges[][3] , MPI_Group *newgroup )
    {
      return Impl::mpi_err_check(MPI_Group_range_incl( group , n , ranges , newgroup ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Group_translate_ranks( group1 , n , ranks1 , group2 , ranks2 ));
    }
    ...
    inline int Iallgather( const void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcount, recvtype );
      return Impl::mpi_err_check(MPI_Iallgather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm , request ));
    }
    inline int Iallgatherv( const void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , const int recvcounts[] , const int displs[] , MPI_Datatype recvtype , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcounts, recvtype, comm );
      return Impl::mpi_err_check(MPI_Iallgatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , comm , request ));
    }
    inline int Iallreduce( const void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Iallreduce( sendbuf , recvbuf , count , datatype , op , comm , request ));
    }
    inline int Ialltoall( const void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcount, recvtype );
      return Impl::mpi_err_check(MPI_Ialltoall( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm , request ));
    }
    inline int Ialltoallv( const void *sendbuf , const int sendcounts[] , const int sdispls[] , MPI_Datatype sendtype , void *recvbuf , const int recvcounts[] , const int rdispls[] , MPI_Datatype recvtype , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( sendcounts, sendtype, comm );
      Impl::RecvVolumeStats( recvcounts, recvtype, comm );
      return Impl::mpi_err_check(MPI_Ialltoallv( sendbuf , sendcounts , sdispls , sendtype , recvbuf , recvcounts , rdispls , recvtype , comm , request ));
    }
	...
	rcounts += recvcounts[i];
      ...
      Impl::SendVolumeStats( scounts, sendtypes[0] );
      Impl::RecvVolumeStats( rcounts, recvtypes[0] );
      return Impl::mpi_err_check(MPI_Ialltoallw( sendbuf , sendcounts , sdispls , sendtypes , recvbuf , recvcounts , rdispls , recvtypes , comm , request ));
    }
	...
	Impl::RecvVolumeStats( count, datatype );
      ...
      return Impl::mpi_err_check(MPI_Ibcast( buffer , count , datatype , root , comm , request ));
    }
#endif
    inline int Ibsend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Ibsend( buf , count , datatype , dest , tag , comm , request ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Iexscan( const void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Iexscan( sendbuf , recvbuf , count , datatype , op , comm , request ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Igather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , root , comm , request ));
    }
	...
	Impl::RecvVolumeStats( recvcounts, recvtype, comm );
      ...
      return Impl::mpi_err_check(MPI_Igatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , root , comm , request ));
    }
    inline int Improbe( int source , int tag , MPI_Comm comm , int *flag , MPI_Message *message , MPI_Status *status )
    {
      return Impl::mpi_err_check(MPI_Improbe( source , tag , comm , flag , message , status ));
    }
    inline int Imrecv( void *buf , int count , MPI_Datatype datatype , MPI_Message *message , MPI_Request *request )
    {
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Imrecv( buf , count , datatype , message , request ));
    }
    inline int Ineighbor_allgather( const void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm , MPI_Request *request )
    {
      ...
      return Impl::mpi_err_check(MPI_Ineighbor_allgather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm , request ));
    }
    ...
    {
      Impl::OneVolumeStats( sendcount, sendtype );
      return Impl::mpi_err_check(MPI_Ineighbor_allgatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , comm , request ));
    }
    ...
    {
      Impl::OneVolumeStats( sendcount, sendtype );
      return Impl::mpi_err_check(MPI_Ineighbor_alltoall( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm , request ));
    }
	...
	scounts += sendcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Ineighbor_alltoallv( sendbuf , sendcounts , sdispls , sendtype , recvbuf , recvcounts , rdispls , recvtype , comm , request ));
    }
	...
	scounts += sendcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Ineighbor_alltoallw( sendbuf , sendcounts , sdispls , sendtypes , recvbuf , recvcounts , rdispls , recvtypes , comm , request ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Info_get_valuelen( info , key , valuelen , flag ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Intercomm_create( local_comm , local_leader , peer_comm , remote_leader , tag , newintercomm ));
    }
    inline int Intercomm_merge( MPI_Comm intercomm , int high , MPI_Comm *newintracomm )
    {
      return Impl::mpi_err_check(MPI_Intercomm_merge( intercomm , high , newintracomm ));
    }
    ...
    {
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Irecv( buf , count , datatype , source , tag , comm , request ));
    }
#if PARALLELZONE_ENABLE_MPI3
	...
	Impl::RecvVolumeStats( count, datatype );
      ...
      return Impl::mpi_err_check(MPI_Ireduce( sendbuf , recvbuf , count , datatype , op , root , comm , request ));
    }
	...
	counts += recvcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Ireduce_scatter( sendbuf , recvbuf , recvcounts , datatype , op , comm , request ));
    }
    inline int Ireduce_scatter_block( const void *sendbuf , void *recvbuf , int recvcount , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm , MPI_Request *request )
    {
      ...
      return Impl::mpi_err_check(MPI_Ireduce_scatter_block( sendbuf , recvbuf , recvcount , datatype , op , comm , request ));
    }
#endif
    inline int Irsend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Irsend( buf , count , datatype , dest , tag , comm , request ));
    }
    ...
    inline int Iscan( const void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Iscan( sendbuf , recvbuf , count , datatype , op , comm , request ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Iscatter( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , root , comm , request ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Iscatterv( sendbuf , sendcounts , displs , sendtype , recvbuf , recvcount , recvtype , root , comm , request ));
    }
#endif
    inline int Isend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Isend( buf , count , datatype , dest , tag , comm , request ));
    }
    inline int Issend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm , MPI_Request *request )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Issend( buf , count , datatype , dest , tag , comm , request ));
    }
    ...
    {
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Mrecv( buf , count , datatype , message , status ));
    }
    ...
    {
      Impl::OneVolumeStats( sendcount, sendtype );
      return Impl::mpi_err_check(MPI_Neighbor_allgather( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm ));
    }
	...
	rcounts += recvcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Neighbor_allgatherv( sendbuf , sendcount , sendtype , recvbuf , recvcounts , displs , recvtype , comm ));
    }
    inline int Neighbor_alltoall( const void *sendbuf , int sendcount , MPI_Datatype sendtype , void *recvbuf , int recvcount , MPI_Datatype recvtype , MPI_Comm comm )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcount, recvtype );
      return Impl::mpi_err_check(MPI_Neighbor_alltoall( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , comm ));
    }
	...
	rcounts += recvcounts[i];
      ...
      Impl::RecvVolumeStats( rcounts, recvtype );
      return Impl::mpi_err_check(MPI_Neighbor_alltoallv( sendbuf , sendcounts , sdispls , sendtype , recvbuf , recvcounts , rdispls , recvtype , comm ));
    }
	...
	rcounts += recvcounts[i];
      ...
      Impl::SendVolumeStats( scounts, sendtypes[0] );
      Impl::RecvVolumeStats( rcounts, recvtypes[0] );
      return Impl::mpi_err_check(MPI_Neighbor_alltoallw( sendbuf , sendcounts , sdispls , sendtypes , recvbuf , recvcounts , rdispls , recvtypes , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Op_free( op ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Pack( inbuf , incount , datatype , outbuf , outsize , position , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Pack_external( datarep , inbuf , incount , datatype , outbuf , outsize , position ));
    }
    inline int Pack_external_size( MPICONST char datarep[] , int incount , MPI_Datatype datatype , MPI_Aint *size )
    {
      return Impl::mpi_err_check(MPI_Pack_external_size( datarep , incount , datatype , size ));
    }
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Put( origin_addr , origin_count , origin_datatype , target_rank , target_disp , target_count , target_datatype , win ));
    }
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Raccumulate( origin_addr , origin_count , origin_datatype , target_rank , target_disp , target_count , target_datatype , op , win , request ));
    }
#endif
    inline int Recv( void *buf , int count , MPI_Datatype datatype , int source , int tag , MPI_Comm comm , MPI_Status *status )
    {
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Recv( buf , count , datatype , source , tag , comm , status ));
    }
    inline int Recv_init( void *buf , int count , MPI_Datatype datatype , int source , int tag , MPI_Comm comm , MPI_Request *request )
    {
      return Impl::mpi_err_check(MPI_Recv_init( buf , count , datatype , source , tag , comm , request ));
    }
	...
	Impl::RecvVolumeStats( count, datatype );
      ...
      return Impl::mpi_err_check(MPI_Reduce( sendbuf , recvbuf , count , datatype , op , root , comm ));
    }
    inline int Reduce_local( MPICONST void *inbuf , void *inoutbuf , int count , MPI_Datatype datatype , MPI_Op op )
    {
      return Impl::mpi_err_check(MPI_Reduce_local( inbuf , inoutbuf , count , datatype , op ));
    }
	...
	counts += recvcounts[i];
      ...
      return Impl::mpi_err_check(MPI_Reduce_scatter( sendbuf , recvbuf , recvcounts , datatype , op , comm ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Reduce_scatter_block( const void *sendbuf , void *recvbuf , int recvcount , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm )
    {
      Impl::SendVolumeStats( recvcount, datatype );
      Impl::RecvVolumeStats( recvcount, datatype );
      return Impl::mpi_err_check(MPI_Reduce_scatter_block( sendbuf , recvbuf , recvcount , datatype , op , comm ));
    }
#endif
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Rget( origin_addr , origin_count , origin_datatype , target_rank , target_disp , target_count , target_datatype , win , request ));
    }
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Rget_accumulate( origin_addr , origin_count , origin_datatype , result_addr , result_count , result_datatype , target_rank , target_disp , target_count , target_datatype , op , win , request ));
    }
    ...
    {
      Impl::OneVolumeStats( origin_count, origin_datatype);
      return Impl::mpi_err_check(MPI_Rput( origin_addr , origin_count , origin_datatype , target_rank , target_disp , target_count , target_datatype , win , request ));
    }
#endif
    inline int Rsend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Rsend( buf , count , datatype , dest , tag , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Rsend_init( buf , count , datatype , dest , tag , comm , request ));
    }
    inline int Scan( MPICONST void *sendbuf , void *recvbuf , int count , MPI_Datatype datatype , MPI_Op op , MPI_Comm comm )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Scan( sendbuf , recvbuf , count , datatype , op , comm ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Scatter( sendbuf , sendcount , sendtype , recvbuf , recvcount , recvtype , root , comm ));
    }
	...
	Impl::RecvVolumeStats( recvcount, recvtype );
      ...
      return Impl::mpi_err_check(MPI_Scatterv( sendbuf , sendcounts , displs , sendtype , recvbuf , recvcount , recvtype , root , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Send_init( buf , count , datatype , dest , tag , comm , request ));
    }
    inline int Sendrecv( MPICONST void *sendbuf , int sendcount , MPI_Datatype sendtype , int dest , int sendtag , void *recvbuf , int recvcount , MPI_Datatype recvtype , int source , int recvtag , MPI_Comm comm , MPI_Status *status )
    {
      Impl::SendVolumeStats( sendcount, sendtype );
      Impl::RecvVolumeStats( recvcount, recvtype );
      return Impl::mpi_err_check(MPI_Sendrecv( sendbuf , sendcount , sendtype , dest , sendtag , recvbuf , recvcount , recvtype , source , recvtag , comm , status ));
    }
    inline int Sendrecv_replace( void *buf , int count , MPI_Datatype datatype , int dest , int sendtag , int source , int recvtag , MPI_Comm comm , MPI_Status *status )
    {
      Impl::SendVolumeStats( count, datatype );
      Impl::RecvVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Sendrecv_replace( buf , count , datatype , dest , sendtag , source , recvtag , comm , status ));
    }
    inline int Ssend( MPICONST void *buf , int count , MPI_Datatype datatype , int dest , int tag , MPI_Comm comm )
    {
      Impl::SendVolumeStats( count, datatype );
      return Impl::mpi_err_check(MPI_Ssend( buf , count , datatype , dest , tag , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Ssend_init( buf , count , datatype , dest , tag , comm , request ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Status_set_elements( status , datatype , count ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Status_set_elements_x( MPI_Status *status , MPI_Datatype datatype , MPI_Count count )
    {
      return Impl::mpi_err_check(MPI_Status_set_elements_x( status , datatype , count ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Testall( count , array_of_requests , flag , array_of_statuses ));
    }
    inline int Testany( int count , MPI_Request array_of_requests[] , int *indx , int *flag , MPI_Status *status )
    {
      return Impl::mpi_err_check(MPI_Testany( count , array_of_requests , indx , flag , status ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Testsome( incount , array_of_requests , outcount , array_of_indices , array_of_statuses ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_darray( size , rank , ndims , array_of_gsizes , array_of_distribs , array_of_dargs , array_of_psizes , order , oldtype , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_hindexed( count , array_of_blocklengths , array_of_displacements , oldtype , newtype ));
    }
#if PARALLELZONE_ENABLE_MPI3
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_hindexed_block( count , blocklength , array_of_displacements , oldtype , newtype ));
    }
#endif
    inline int Type_create_hvector( int count , int blocklength , MPI_Aint stride , MPI_Datatype oldtype , MPI_Datatype *newtype )
    {
      return Impl::mpi_err_check(MPI_Type_create_hvector( count , blocklength , stride , oldtype , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_indexed_block( count , blocklength , array_of_displacements , oldtype , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_keyval( type_copy_attr_fn , type_delete_attr_fn , type_keyval , extra_state ));
    }
    inline int Type_create_resized( MPI_Datatype oldtype , MPI_Aint lb , MPI_Aint extent , MPI_Datatype *newtype )
    {
      return Impl::mpi_err_check(MPI_Type_create_resized( oldtype , lb , extent , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_struct( count , array_of_blocklengths , array_of_displacements , array_of_types , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_create_subarray( ndims , array_of_sizes , array_of_subsizes , array_of_starts , order , oldtype , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_get_attr( datatype , type_keyval , attribute_val , flag ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_get_contents( datatype , max_integers , max_addresses , max_datatypes , array_of_integers , array_of_addresses , array_of_datatypes ));
    }
    inline int Type_get_envelope( MPI_Datatype datatype , int *num_integers , int *num_addresses , int *num_datatypes , int *combiner )
    {
      return Impl::mpi_err_check(MPI_Type_get_envelope( datatype , num_integers , num_addresses , num_datatypes , combiner ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_get_name( datatype , type_name , resultlen ));
    }
    inline int Type_get_true_extent( MPI_Datatype datatype , MPI_Aint *true_lb , MPI_Aint *true_extent )
    {
      return Impl::mpi_err_check(MPI_Type_get_true_extent( datatype , true_lb , true_extent ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Type_get_true_extent_x( MPI_Datatype datatype , MPI_Count *lb , MPI_Count *extent )
    {
      return Impl::mpi_err_check(MPI_Type_get_true_extent_x( datatype , lb , extent ));
    }
#endif
    ...
    {
      return Impl::mpi_err_check(MPI_Type_indexed( count , array_of_blocklengths , array_of_displacements , oldtype , newtype ));
    }
    inline int Type_set_attr( MPI_Datatype datatype , int type_keyval , void *attribute_val )
    {
      return Impl::mpi_err_check(MPI_Type_set_attr( datatype , type_keyval , attribute_val ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Type_vector( count , blocklength , stride , oldtype , newtype ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Unpack( inbuf , insize , position , outbuf , outcount , datatype , comm ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Unpack_external( datarep , inbuf , insize , position , outbuf , outcount , datatype ));
    }
    inline int Unpublish_name( MPICONST char *service_name , MPI_Info info , MPICONST char *port_name )
    {
      return Impl::mpi_err_check(MPI_Unpublish_name( service_name , info , port_name ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Waitall( count , array_of_requests , array_of_statuses ));
    }
    inline int Waitany( int count , MPI_Request array_of_requests[] , int *indx , MPI_Status *status )
    {
      return Impl::mpi_err_check(MPI_Waitany( count , array_of_requests , indx , status ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Waitsome( incount , array_of_requests , outcount , array_of_indices , array_of_statuses ));
    }
#if PARALLELZONE_ENABLE_MPI3
    inline int Win_allocate( MPI_Aint size , int disp_unit , MPI_Info info , MPI_Comm comm , void *baseptr , MPI_Win *win )
    {
      return Impl::mpi_err_check(MPI_Win_allocate( size , disp_unit , info , comm , baseptr , win ));
    }
    inline int Win_allocate_shared( MPI_Aint size , int disp_unit , MPI_Info info , MPI_Comm comm , void *baseptr , MPI_Win *win )
    {
      return Impl::mpi_err_check(MPI_Win_allocate_shared( size , disp_unit , info , comm , baseptr , win ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Win_create( base , size , disp_unit , info , comm , win ));
    }
#if PARALLELZONE_ENABLE_MPI3
    ...
    {
      return Impl::mpi_err_check(MPI_Win_create_errhandler( win_errhandler_fn , errhandler ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Win_create_keyval( win_copy_attr_fn , win_delete_attr_fn , win_keyval , extra_state ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Win_get_attr( win , win_keyval , attribute_val , flag ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Win_set_attr( win , win_keyval , attribute_val ));
    }
    ...
    {
      return Impl::mpi_err_check(MPI_Win_shared_query( win , rank , size , disp_unit , baseptr ));
    }
#endif
  ...
  } // end namespace ParallelZone::MPI
} // namespace ParallelZone
